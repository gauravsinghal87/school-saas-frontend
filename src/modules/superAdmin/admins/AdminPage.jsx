...
export default function AdminPage() {
    ...
    const { data: apiResponse, isLoading, refetch } = getAdminListQuery({ page, limit, search });
    ...
    const admins = apiResponse?.results ?? [];
    const total = apiResponse?.results?.pagination?.total ?? 0;
    ...
    const columns = [
        ...
        },
        {
            key: "school",
            label: "School",
            render: (_, row) => row?.school_id?.name || "—", // ✅ nested
        },
        {
            key: "status",
            label: "Status",
            ...
            render: (val) => {
                ...
                return (
                    <span
                        className={`inline-flex px-2.5 py-0.5 rounded-full text-xs font-semibold ${isActive
        ...
        <div className="min-h-screen bg-surface-page px-4 py-8">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-text-heading">Admins</h1>
                        <p className="text-sm text-text-secondary mt-0.5">
                            Manage all registered admins on EduCore.
                        </p>
                    </div>
                    {/* <button
                        onClick={openAdd}
                ...
                <DataTable
                    ...
                    loading={isLoading}
                    rowKey="_id"
                    emptyMessage="No admins registered yet"
