...
import { createAcademicYearMutation, updateAcademicYearMutation, deleteSubscriptionMutation, updateSubscriptionStatusMutation } from "../../../hooks/useQueryMutations";
  ...
  },
{
...
},
  {
    ...
    const { mutateAsync: createSubscriptionPlan, isPending } = createAcademicYearMutation();

    const { register, handleSubmit, control, reset, formState: { errors } } = useForm({});
    const { data: apiResponse, isLoading, refetch } = academicYearList();
    const { mutateAsync: updateAcademicYear, isPending: isupdating } = updateAcademicYearMutation();
    ...
    return (
        <div className="md:p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-text-heading">Academic Sessions</h1>
                    <p className="text-sm text-text-secondary mt-0.5">
                        Manage all academic sessions on EduCore.
                    </p>
                </div>
            ...
            <SidePanel
                ...
                title={`${mode.toUpperCase()} Academic Session`}
            >
