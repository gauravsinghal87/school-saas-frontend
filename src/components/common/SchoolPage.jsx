...
import { createSchoolMutation, updateSchoolStatusMutation, useSchoolList } from "../../hooks/useQueryMutations";
...
// import AppPhoneInput from "../../components/common/PhoneInput";
// import Button from "../../components/common/Button";
// import { Eye, Icon, Pencil, Trash2 } from "lucide-react";
// import { createSchoolMutation, updateSchoolStatusMutation, useSchoolList } from "../../hooks/useQueryMutations";
...
//                         disabled={isPending && variables?.id === row._id}
//                         className={`relative w-12 h-6 flex items-center rounded-full p-1 transition-all duration-300 
//         ${isPending && variables?.id === row._id
...
//                     >
//                         <div
//                             className={`bg-white w-4 h-4 rounded-full shadow transform transition-all duration-300 ${row.isActive ? "translate-x-6" : "translate-x-0"
//                                 }`}
//                         />
//                     </button>
//                 );
...
//                                     Current status:
//                                     <span
//                                         className={`inline-flex px-2.5 py-0.5 rounded-full text-xs font-semibold ${field.value
...
//                                         className={`w-12 h-6 flex items-center rounded-full p-1 transition-all duration-300 ${field.value
//                                             ? "bg-success shadow-md shadow-success/30"
//                                             : "bg-border"
//                                             }`}
//                                     >
//                                         <div
//                                             className={`bg-white w-4 h-4 rounded-full shadow transform transition-all duration-300 ${field.value
//                                                 ? "translate-x-6"
//                                                 : "translate-x-0"
//                                                 }`}
//                                         />
...
//                                         {...register("adminName", fieldRules.adminName)}
//                                     />
...
//                                         {...register("adminEmail", fieldRules.adminEmail)}
//                                     />
...
//                                     This will{" "}
//                                     <strong>
//                                         {field.value ? "deactivate" : "activate"}
//                                     </strong>{" "}
//                                     the school.
//                                     {field.value
//                                         ? " All associated logins will be suspended."
//                                         : " The school will regain full access."}
//                                 </p>
//                             </div>
//                         )}
//                     />}
...
//                 )}
//                 {/* Submit Button */}
//                 {mode === 'add' && <div className="flex gap-3 pt-2">
//                     <Button type="submit" loading={loading} className="flex-1">
//                         {loading
//                             ? "Saving…"
//                             : defaultValues
...
//                         title="Delete"
//                         className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-error/10"
//                     >
